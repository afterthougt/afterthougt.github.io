...
# [논문 리뷰] BERT: Pre-training of Deep Bidirectional Transformers for Language Understanding (NAACL 2019, BERT)
...
<details>
<summary>언어 모델(Language Modeling)의 사전 학습의 유효성이 증명되고 있는 사례</summary>
    - 문장 수준
...
<details>
<summary>2. 관련 연구(Related Works)</summary>
...
<summary> Table 1 간략 설명
    ...
    - 중간 성능의 태스크
        ...
        - 문장 간 의미론적 유사 관계(STS-B; 86.5)</summary>
...
- ‘정답없음’ 모델링 방법
    ...
    그리고 $\tau$는 검증 세트의 F1 점수를 최대화하는 값으로 설정.
